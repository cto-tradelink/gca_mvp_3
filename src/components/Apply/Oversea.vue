<template>
    <div id="base_info" style="padding-bottom:150px;">
        <div id="case_con">
            <div id="base_title">해외 진출현황</div>            
            <div class="wr_con_1">
                 <div v-on:click="add_oversea($event)" class="add_btn">추가</div>
                <table>
                    <tr>
                        <td style="padding-bottom:24px;">국가</td>
                        <td style="padding-bottom:24px;">
                            <input id="nation" class="input_normal" type="text" placeholder="국가명을 입력하세요" value=""> 
                        </td>
                    </tr>
                    <tr>
            ...
            <div v-for="oversea in startup.oversea" class="wr_con_1">
                <table>
                    <tr>
                        <td style="padding-bottom:24px;">국가</td>
                        <td style="padding-bottom:24px;"><input class="input_normal" type="text" placeholder="국가명을 입력하세요" :value="oversea.nation"> </td>
                    </tr>
                    <tr>
                        <td style="vertical-align:top; padding-top:16px;">진출현황<br><span class="text_num">최대 1000자 내외</span></td>
                        <td>

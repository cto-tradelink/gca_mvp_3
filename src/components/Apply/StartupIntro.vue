<template>
    <div id="base_info" style="padding-bottom:200px;">
        <div id="case_con">
            <div id="base_title">기업소개</div>            
        

            <div class="wr_con_1">
                <table>
                    <tr>
                        <td style="vertical-align:top; padding-top:16px;">기업소개<br><span class="text_num">최대 1000자 내외</span></td>
                        <td>
                            <textarea v-model="startup.company_intro" placeholder="기업소개글을 입력하세요."></textarea>
                            </td>
                    </tr>                                    
                </table>
            </div>
            ...
            <div class="wr_con_1">
                <table>
                    <tr>
                        <td style="vertical-align:top; padding-top:16px;">연혁(주요 경력)</td>
                        <td>
                           <Datepicker :minimumView="'month'" :maximumView="'month'"></Datepicker><input class="input_normal" placeholder="연혁을 입력하세요.">
                        </td>
                    </tr>                                    
                </table>
            </div>

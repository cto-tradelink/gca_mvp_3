<template>
    <div class="app_seg">
        ...
        <div class="text_con">
            ...
            <div class="sub">
                <div class="sub_int"><i class="fas fa-heart"></i>{{c.com}}</div>
                <div class="sub_comp"><i class="fas fa-fire"></i>{{s.comp}}</div>
                <div class="sub_d_day"><i class="far fa-clock"></i>D-13</div>
                <div v-if="pro == 'open'" class="sub_agency">게시일 : {{s.open_date.split("T")[0]}} </div>  
                <div v-if="pro == 'wait'" class="sub_agency">승인 요청 : {{s.up_date.split("T")[0]}} </div>                
            </div>
        </div>
        <div class="btn_con">
             <div class="app_btn">

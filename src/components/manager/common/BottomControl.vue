<template>
    ...
    <div id="bottom_control" style="width:100%; height:56px;position:fixed; bottom:0px;; background-color: #ced4da;margin-top:254px;" >
        <div style="width:1224px; margin:0px auto; height:56px;">
            ...
            <div id="application" v-if="is_completed"  style="  width: 231px; height: 56px;  opacity:1; font-weight: bold; text-align:center; font-size: 16px;color: #fff;background-color:#1b49f4;float:right;line-height:56px; cursor:pointer">지원서 양식 > </div>
            <div id="apply_next" v-else v-on:click="submit" style="  width: 231px; height: 56px;  opacity:1; font-size: 16px; font-weight: bold;  background-color: #1b49f4;text-align:center; lien-height:56px;color:#fff; float:right;line-height:56px;">승인요청</div>
